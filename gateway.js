...
class YSubdomain
{
    ...
    async runJob()
    {
        ...
        this.timeoutId = setTimeout(() => { this.runJob(); }, nextRun);
    }
        ...
        for(let name in YSubdomain.list) {
            ...
            for(let i = 0; i < subdom.cback.length; i++) {
                ...
                outcb.push({
                    ...
                    Credentials: { user: YSubdomain.Obfuscate(cbdata.Credentials.user), pass: YSubdomain.Obfuscate(cbdata.Credentials.pass) },
